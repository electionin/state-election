                ...
                <div className="p-4">
                    ...
                    <div className="prose prose-sm text-slate-800">
                        <p className="leading-relaxed">
                            ...
                            The information has been sourced from the respective State Election website.
                            If you notice any errors or discrepancies, please <a href="https://github.com/electionin/state-election/issues"><u>let us know</u></a> so they can be reviewed.
                        </p>
                    </div>
